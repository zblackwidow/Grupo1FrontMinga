                    ...
                    <div className="w-full my-4 flex justify-center items-center">
                        <div className="w-[500px]  mx-16">
                            <div className="flex gap-4  my-4">
                                <button className="rounded-full   bg-[#999999] p-2 text-white font-semibold">
                                    All
                                </button>
                                <button className="rounded-full  bg-[#FFE0DF] p-2 text-[#EF8481] font-semibold">
                                    Shōnen
                                </button>
                                <button className="rounded-full  bg-[#FFDFC8] p-2 text-[#FC9C57] font-semibold">
                                    Seinen
                                </button>
                                <button className="rounded-full  bg-[#D1FBF0] p-2 text-[#00BA88] font-semibold">
                                    Shōjo
                                </button>
                                <button className="rounded-full  bg-[#E0DBFF] p-2 text-[#8883F0] font-semibold">
                                    Kodomo
                                </button>
                            </div>
                        </div>
