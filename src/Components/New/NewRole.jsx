        ...
        <main className="w-full flex items-center">
            <div className="w-1/2 h-screen">
                <div className="w-full flex flex-col justify-center items-center ">
                    ...
                    <div className="flex"><h2 className="text-orange-500 text-2xl">Minga</h2>
                        <h2 className="ml-1 text-2xl">雪</h2>
                    </div>
                    <div className="w-full sm:w-[60vw] xl:w-[40vw] h-[12vh] md:h-[10vh] border-2 border-gray-400 rounded-lg flex my-10">
                        {/* contenedor de Join autor */}
                        <div className="flex items-center justify-end bg-orange-500 md:w-1/3 w-2/4  ">
                            ...
                            <div className="flex items-center my-4">
                                ...
                                <img className="absolute m-10 rounded-full w-14 h-14 bg-fixed object-cover" src="https://s3-alpha-sig.figma.com/img/8492/a785/4211a986cf32f5be6f5259d5d00d18e2?Expires=1734307200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=W99~IjyXbkAQ3Ej9NL3z-u~TVB~ujW3PvBNbwVxsA4GAeq1MCCYBII8ad7YxYptq9axQHZF3vu~8xXagETDzstI1LCTim6EBjvqomaMGEnOPxPFcMD1d0CZgVJTjoywcls3tR0l~A3em-qr6sncW8auANdbhbJpCGc1SGoBTZTtVY~Au4Z3mOt8e3J28LStV~GF38AtKWxHtowpm-4~2vEmjv2~VVbpIbhTZD2oEV3aeSlxSP5OGoS3yAgudjpOACt7g-khHqMHY4KH6qza6oXffuDnlGgrQJPV6X9W98uZzP27AaqVgl6QL8RfTY8meLlwnCoqeT2qvKb6dgO1xwA__" alt="chica1" />
