          ...
          <>
            ...
            <div className="absolute top-1/2 transform -translate-y-1/2 flex justify-between w-full px-4">
              <button
                ...
                className={`px-4 py-2 bg-transparent rounded ${isFirstPage ? "opacity-50 cursor-not-allowed" : "hover:bg-[#f97316]"
                  }`}
              >
                {/* Flecha izquierda */}
              ...
              <button
                ...
                disabled={isLastPage}
                className={`px-4 py-2 bg-transparent rounded ${isLastPage ? "opacity-50 cursor-not-allowed" : "hover:bg-[#f97316]"
                  }`}
              >
                {/* Flecha derecha */}
                <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
