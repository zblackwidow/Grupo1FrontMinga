...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-8 flex left-0 w-full h-14 justify-between px-12  bg-transparent text-white z-50">
            ...
            {isMenuOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-0" onClick={closeMenu}></div>
            )}
            ...
            <path
                d="M131.08 9.36V13.12H160.76V9.36H131.08ZM133.92 19.96V23.08H142.24V19.96H133.92ZM133.04 24.56V27.68H142.28V24.56H133.04ZM149.48 24.56V27.68H158.84V24.56H149.48ZM149.48 19.96V23.08H157.88V19.96H149.48ZM132.92 35V38.6H156.88V35H132.92ZM131.44 40.6V44.44H157.2V40.6H131.44ZM143.52 10.8V28.12H148.2V10.8H143.52ZM132 29.32V33.08H154.88V45.72H159.64V29.32H132ZM128.36 14.76V23.92H132.6V18.44H159.24V23.92H163.68V14.76H128.36Z"
                fill="#FAFCFC"
            />
            <path
